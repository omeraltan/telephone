...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rehber.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REHBER_LIST actions', async () => {
    ...
    it('dispatches FETCH_REHBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REHBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REHBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REHBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REHBER actions', async () => {
      const expectedActions = [
        {
